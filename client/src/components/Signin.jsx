...
const Signin = () => {
  ...
  // return (
  //   <div class="bg-gray-100 min-h-screen py-20 px-4 sm:px-6 lg:px-8">
  ...
  //               <button
  //               type="submit"
  //               class="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
  //               disabled={uploading}
  //             >
  ...
  //             ) : (
  //               <div class="w-full mx-">
  //                 <span class="font-semibold text-lg">Cuisine : {cuisine} </span>
  //               </div>
  ...
  //         {success && (
  //           <div class="mt-4 bg-green-100 p-4 rounded-lg flex items-center justify-center">
  //             <svg
  ...
  //         <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
  ...
  //               </div>
  //               <div class="p-4">
  //                 <h4 class="text-blue-gray-800 text-xl mb-2">
  ...
  //                   <p class="bg-red-100 text-red-500 h-8 w-8 flex items-center justify-center text-sm font-semibold rounded-full">
  //                     {restaurant.AggregateRating} 
  //                   </p>
  //                   <p class="ms-3 text-gray-900 font-medium">
  ...
  return (
    <div >
      <p class = "text-5xl text-center font-bold underline">in</p>
      sign
    </div>
